...
export class BezierCurve {
    ...
    copy() {
        return new BezierCurve(this.p0.copy(), this.c0.copy(), this.c1.copy(), this.p1.copy());
    }
    ...
    getPointAt(t) {
        ...
        let x = (1 - t) * (1 - t) * (1 - t) * this.p0.x +
            3 * (1 - t) * (1 - t) * t * this.c0.x +
            3 * (1 - t) * t * t * this.c1.x +
            t * t * t * this.p1.x;
        let y = (1 - t) * (1 - t) * (1 - t) * this.p0.y +
    ...
    curveTo(path) {
        path.bezierCurveTo(this.c0.x, this.c0.y, this.c1.x, this.c1.y, this.p1.x, this.p1.y);
    }
    reverseCurveTo(path) {
        path.bezierCurveTo(this.c1.x, this.c1.y, this.c0.x, this.c0.y, this.p0.x, this.p0.y);
    }
