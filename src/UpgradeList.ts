...
export const UpgradeList = {
	...
	FLY_SPEED: new Upgrade(
		"FLY_SPEED",
		UpgradeType.FLY_SPEED,
		"Flight Speed",
	...
	MINING_DAMAGE: new Upgrade(
		"MINING_DAMAGE",
		UpgradeType.MINING_DAMAGE,
		"Basic Mining",
		"Increases mining strength.",
		25,
		1.5,
		10,
		1.5,
	...
	MINING_SPEED: new Upgrade(
		...
		1,
		3,
		[{ upgradeId: "MINING_DAMAGE", requiredLevel: 3 }],
	),

	INVENTORY: new Upgrade(
		"INVENTORY",
